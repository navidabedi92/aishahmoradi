export const API_ADDRESS = "https://apilab.greendataware.com/api";
//export const API_ADDRESS = "https://api.greendataware.com/api";
// export const API_ADDRESS = "http://localhost:5000/api";

export const IsCompressed = "&IsCompressed=false";
export const WITH_MEDIA_BINARY = "&WithMediaBinary=false";
...
// export const BACKGROUND_COLOR = "#F6F6F6"; //"#dce6e0",
export const BACKGROUND_COLOR = "#253856";
export const BACKGROUND_IMAGE1 = "url('./background.png')";
export const BACKGROUND_IMAGE = "url('./background.png')";

export const FORM_CAPTION_COLOR = "#002a6e"; //#FE8B4F
export const MODAL_FORM_CAPTION_COLOR = "#002a6e"; //"#002259"
export const REPORT_COLUMN_CAPTION_COLOR = "#002a6e"; //"#002259"

export const WORKLIST_BACKGROUND_COLOR1 = "#0d284f";
export const WORKLIST_BACKGROUND_COLOR2 = "#0c2f5e";

export const WORKLIST_RIGHT_COL_COLOR = "#ffe2ab";
export const WORKLIST_LEFT_COL_COLOR = "white";
export const WORKLIST_ARROW_COLOR = "white";

export const DASHBOARD_BACKGROUND_COLOR = "#253856";
export const DASHBOARD_TEXT_COLOR = "white";
export const DASHBOARD_TICK_COLOR = "white";
export const DASHBOARD_TOOLTIP_TEXT_COLOR = "black";
export const DASHBOARD_CAPTION_PADDING = "4px";
export const DASHBOARD_DOMAIN_CAPTION_COLOR = "orange";

export const HEADER_BACKGROUND_COLOR = "#253856";
export const HEADER_HEIGHT = 36;

export const HEADER_AUTH = "Green2019";

export const Header_WebSiteCode = "ai";
